...
export const CREDENTIAL_TYPES: CredentialTypeConfig[] = [
  {
    ...
    predicates: [
      { id: 'age', labelKey: 'sandbox.predAge', descKey: 'sandbox.predAgeDesc', predicate: { claim: 'birth_date', op: 'lte', value: isoDateYearsAgo(18) }, defaultChecked: true },
      ...
      { id: 'age_lte', labelKey: 'sandbox.predAgeLte', descKey: 'sandbox.predAgeLteDesc', predicate: { claim: 'birth_date', op: 'gte', value: isoDateYearsAgo(65) }, defaultChecked: false },
