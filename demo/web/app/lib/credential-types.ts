...
export const CREDENTIAL_TYPES: CredentialTypeConfig[] = [
  {
    ...
    predicates: [
      ...
      { id: 'reveal_doc', labelKey: 'demo.revealDocNumber', descKey: 'demo.revealDocNumberDesc', predicate: { claim: 'document_number', op: 'reveal', value: null }, defaultChecked: false },
      { id: 'reveal_given_name', labelKey: 'demo.revealGivenName', descKey: 'demo.revealGivenNameDesc', predicate: { claim: 'given_name', op: 'reveal', value: null }, defaultChecked: false },
      { id: 'reveal_family_name', labelKey: 'demo.revealFamilyName', descKey: 'demo.revealFamilyNameDesc', predicate: { claim: 'family_name', op: 'reveal', value: null }, defaultChecked: false },
      { id: 'reveal_nationality', labelKey: 'demo.revealNationality', descKey: 'demo.revealNationalityDesc', predicate: { claim: 'nationality', op: 'reveal', value: null }, defaultChecked: false },
    ],
  },
  {
    id: 'drivers_license',
    ...
    predicates: [
      ...
      { id: 'reveal_license', labelKey: 'demo.revealLicenseNumber', descKey: 'demo.revealLicenseNumberDesc', predicate: { claim: 'license_number', op: 'reveal', value: null }, defaultChecked: false },
      { id: 'reveal_holder', labelKey: 'demo.revealHolderName', descKey: 'demo.revealHolderNameDesc', predicate: { claim: 'holder_name', op: 'reveal', value: null }, defaultChecked: false },
      { id: 'reveal_category', labelKey: 'demo.revealCategory', descKey: 'demo.revealCategoryDesc', predicate: { claim: 'category', op: 'reveal', value: null }, defaultChecked: false },
    ],
  },
  {
    id: 'diploma',
    ...
    predicates: [
      ...
      { id: 'reveal_diploma', labelKey: 'demo.revealDiplomaNumber', descKey: 'demo.revealDiplomaNumberDesc', predicate: { claim: 'diploma_number', op: 'reveal', value: null }, defaultChecked: false },
      { id: 'reveal_student_name', labelKey: 'demo.revealStudentName', descKey: 'demo.revealStudentNameDesc', predicate: { claim: 'student_name', op: 'reveal', value: null }, defaultChecked: false },
      { id: 'reveal_university', labelKey: 'demo.revealUniversity', descKey: 'demo.revealUniversityDesc', predicate: { claim: 'university', op: 'reveal', value: null }, defaultChecked: false },
      { id: 'reveal_degree', labelKey: 'demo.revealDegree', descKey: 'demo.revealDegreeDesc', predicate: { claim: 'degree', op: 'reveal', value: null }, defaultChecked: false },
      { id: 'reveal_field', labelKey: 'demo.revealFieldOfStudy', descKey: 'demo.revealFieldOfStudyDesc', predicate: { claim: 'field_of_study', op: 'reveal', value: null }, defaultChecked: false },
    ],
  },
  {
    id: 'student_id',
    ...
    predicates: [
      ...
      { id: 'university_match', labelKey: 'demo.predUniversityMatch', descKey: 'demo.predUniversityMatchDesc', predicate: { claim: 'university', op: 'eq', value: '__FROM_FORM__' }, defaultChecked: false },
      { id: 'reveal_student_num', labelKey: 'demo.revealStudentNumber', descKey: 'demo.revealStudentNumberDesc', predicate: { claim: 'student_number', op: 'reveal', value: null }, defaultChecked: false },
      { id: 'reveal_stu_name', labelKey: 'demo.revealStuName', descKey: 'demo.revealStuNameDesc', predicate: { claim: 'student_name', op: 'reveal', value: null }, defaultChecked: false },
      { id: 'reveal_stu_uni', labelKey: 'demo.revealStuUniversity', descKey: 'demo.revealStuUniversityDesc', predicate: { claim: 'university', op: 'reveal', value: null }, defaultChecked: false },
      { id: 'reveal_faculty', labelKey: 'demo.revealFaculty', descKey: 'demo.revealFacultyDesc', predicate: { claim: 'faculty', op: 'reveal', value: null }, defaultChecked: false },
    ],
  },
  {
    id: 'vehicle',
    ...
    predicates: [
      ...
      { id: 'reveal_vin', labelKey: 'demo.revealVin', descKey: 'demo.revealVinDesc', predicate: { claim: 'vin', op: 'reveal', value: null }, defaultChecked: false },
      { id: 'reveal_plate', labelKey: 'demo.revealPlateNumber', descKey: 'demo.revealPlateNumberDesc', predicate: { claim: 'plate_number', op: 'reveal', value: null }, defaultChecked: false },
      { id: 'reveal_owner', labelKey: 'demo.revealOwnerName', descKey: 'demo.revealOwnerNameDesc', predicate: { claim: 'owner_name', op: 'reveal', value: null }, defaultChecked: false },
      { id: 'reveal_owner_doc', labelKey: 'demo.revealOwnerDocNumber', descKey: 'demo.revealOwnerDocNumberDesc', predicate: { claim: 'owner_document_number', op: 'reveal', value: null }, defaultChecked: false },
    ],
  },
]
