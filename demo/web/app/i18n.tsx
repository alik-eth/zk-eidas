...
const translations: Record<string, Record<Locale, string>> = {
  ...
  "proposal.comparisonSubtitle": {
    en: "How zk-eidas compares to alternative selective disclosure approaches proposed for the EU Digital Identity Wallet.",
    uk: "Порівняння zk-eidas з альтернативними підходами селективного розкриття, запропонованими для Європейського цифрового гаманця ідентичності.",
  },
  "proposal.col.batch": { en: "Batch Issuance", uk: "Пакетна видача" },
  "proposal.col.bbs": { en: "BBS+ Signatures", uk: "Підписи BBS+" },
  "proposal.col.longfellow": { en: "Longfellow (bare)", uk: "Longfellow (базовий)" },
  ...
  "proposal.row.predicates": { en: "Predicate proofs", uk: "Предикатні докази" },
  "proposal.row.unlinkability": { en: "Unlinkability", uk: "Незв'язуваність" },
  "proposal.row.holderBinding": { en: "Holder binding", uk: "Прив'язка до власника" },
  "proposal.row.identityEscrow": { en: "Identity escrow", uk: "Ескроу ідентичності" },
  "proposal.row.trustedSetup": { en: "Trusted setup", uk: "Довірена ініціалізація" },
  "proposal.row.quantumSafe": { en: "Quantum resistant", uk: "Квантова стійкість" },
  ...
  "proposal.row.proofSize": { en: "Proof / presentation size", uk: "Розмір доказу / презентації" },
  ...
  "proposal.cell.batch.predicates": { en: "Issuer-side only (pre-computed fields)", uk: "Тільки на стороні емітента (попередньо обчислені поля)" },
  "proposal.cell.batch.unlinkability": { en: "By copy count (runs out)", uk: "За кількістю копій (вичерпується)" },
  "proposal.cell.batch.binding": { en: "Per-copy key", uk: "Ключ на кожну копію" },
  "proposal.cell.batch.escrow": { en: "No", uk: "Ні" },
  ...
  "proposal.cell.batch.issuerLoad": { en: "N signatures", uk: "N підписів" },
  "proposal.cell.batch.storage": { en: "N copies", uk: "N копій" },
  "proposal.cell.batch.revocation": { en: "Revoke N credentials", uk: "Відкликати N облікових даних" },
  "proposal.cell.batch.size": { en: "~100-200 B", uk: "~100-200 Б" },
  "proposal.cell.bbs.eidas": { en: "Not in standard", uk: "Не в стандарті" },
  "proposal.cell.bbs.sd": { en: "Yes", uk: "Так" },
  "proposal.cell.bbs.predicates": { en: "Issuer-side only (pre-computed fields)", uk: "Тільки на стороні емітента (попередньо обчислені поля)" },
  ...
  "proposal.cell.bbs.escrow": { en: "No", uk: "Ні" },
  "proposal.cell.bbs.setup": { en: "No", uk: "Ні" },
  "proposal.cell.bbs.quantum": { en: "No (pairing-based)", uk: "Ні (на базі спарювань)" },
  "proposal.cell.bbs.issuerLoad": { en: "1 signature", uk: "1 підпис" },
  "proposal.cell.bbs.storage": { en: "1 credential", uk: "1 облікові дані" },
  "proposal.cell.bbs.revocation": { en: "Revoke 1", uk: "Відкликати 1" },
  "proposal.cell.bbs.size": { en: "~100 B", uk: "~100 Б" },
  "proposal.cell.lf.eidas": { en: "Not specified", uk: "Не визначено" },
  "proposal.cell.lf.sd": { en: "Yes", uk: "Так" },
  "proposal.cell.lf.predicates": { en: "Holder-side (any threshold at presentation)", uk: "На стороні власника (будь-який поріг при презентації)" },
  "proposal.cell.lf.unlinkability": { en: "Built-in (ZK proof)", uk: "Вбудована (ZK доказ)" },
  "proposal.cell.lf.binding": { en: "None", uk: "Відсутня" },
  "proposal.cell.lf.escrow": { en: "No", uk: "Ні" },
  "proposal.cell.lf.setup": { en: "No (transparent)", uk: "Ні (прозора)" },
  "proposal.cell.lf.quantum": { en: "Yes (hash-based)", uk: "Так (на базі хешів)" },
  "proposal.cell.lf.issuerLoad": { en: "1 signature", uk: "1 підпис" },
  "proposal.cell.lf.storage": { en: "1 credential", uk: "1 облікові дані" },
  "proposal.cell.lf.revocation": { en: "Revoke 1", uk: "Відкликати 1" },
  "proposal.cell.lf.size": { en: "~360 KB", uk: "~360 КБ" },
  "proposal.cell.zk.eidas": { en: "QEAA-compatible", uk: "Сумісний з QEAA" },
  "proposal.cell.zk.sd": { en: "Yes", uk: "Так" },
  "proposal.cell.zk.predicates": { en: "Holder-side (any threshold at presentation)", uk: "На стороні власника (будь-який поріг при презентації)" },
  "proposal.cell.zk.unlinkability": { en: "Built-in (ZK proof + nullifiers)", uk: "Вбудована (ZK доказ + нуліфаєри)" },
  "proposal.cell.zk.binding": { en: "Unlinkable (device key hash)", uk: "Незв'язуваний (хеш ключа пристрою)" },
  "proposal.cell.zk.escrow": { en: "ML-KEM-768 + court order", uk: "ML-KEM-768 + судовий наказ" },
  "proposal.cell.zk.setup": { en: "No (transparent)", uk: "Ні (прозора)" },
  "proposal.cell.zk.quantum": { en: "Yes (hash-based + ML-KEM)", uk: "Так (на базі хешів + ML-KEM)" },
