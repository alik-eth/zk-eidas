...
const translations: Record<string, Record<Locale, string>> = {
  ...
  // ── Reveal entries ───────────────────────────────────────────────────────
  "demo.revealDocNumber": { en: "Reveal document number", uk: "Розкрити номер документа" },
  "demo.revealDocNumberDesc": { en: "Disclose the actual document number with ZK proof of authenticity", uk: "Показати фактичний номер документа з ZK доказом автентичності" },
  "demo.revealGivenName": { en: "Reveal given name", uk: "Розкрити ім\u2019я" },
  "demo.revealGivenNameDesc": { en: "Disclose the given name with ZK proof of authenticity", uk: "Показати ім\u2019я з ZK доказом автентичності" },
  "demo.revealFamilyName": { en: "Reveal family name", uk: "Розкрити прізвище" },
  "demo.revealFamilyNameDesc": { en: "Disclose the family name with ZK proof of authenticity", uk: "Показати прізвище з ZK доказом автентичності" },
  "demo.revealNationality": { en: "Reveal nationality", uk: "Розкрити громадянство" },
  "demo.revealNationalityDesc": { en: "Disclose the nationality with ZK proof of authenticity", uk: "Показати громадянство з ZK доказом автентичності" },
  "demo.revealLicenseNumber": { en: "Reveal license number", uk: "Розкрити номер посвідчення" },
  "demo.revealLicenseNumberDesc": { en: "Disclose the license number with ZK proof of authenticity", uk: "Показати номер посвідчення з ZK доказом автентичності" },
  "demo.revealHolderName": { en: "Reveal holder name", uk: "Розкрити ім\u2019я власника" },
  "demo.revealHolderNameDesc": { en: "Disclose the holder name with ZK proof of authenticity", uk: "Показати ім\u2019я власника з ZK доказом автентичності" },
  "demo.revealCategory": { en: "Reveal license category", uk: "Розкрити категорію" },
  "demo.revealCategoryDesc": { en: "Disclose the license category with ZK proof of authenticity", uk: "Показати категорію посвідчення з ZK доказом автентичності" },
  "demo.revealDiplomaNumber": { en: "Reveal diploma number", uk: "Розкрити номер диплома" },
  "demo.revealDiplomaNumberDesc": { en: "Disclose the diploma number with ZK proof of authenticity", uk: "Показати номер диплома з ZK доказом автентичності" },
  "demo.revealStudentName": { en: "Reveal student name", uk: "Розкрити ім\u2019я студента" },
  "demo.revealStudentNameDesc": { en: "Disclose the student name with ZK proof of authenticity", uk: "Показати ім\u2019я студента з ZK доказом автентичності" },
  "demo.revealUniversity": { en: "Reveal university", uk: "Розкрити університет" },
  "demo.revealUniversityDesc": { en: "Disclose the university name with ZK proof of authenticity", uk: "Показати назву університету з ZK доказом автентичності" },
  "demo.revealDegree": { en: "Reveal degree", uk: "Розкрити ступінь" },
  "demo.revealDegreeDesc": { en: "Disclose the degree with ZK proof of authenticity", uk: "Показати ступінь з ZK доказом автентичності" },
  "demo.revealFieldOfStudy": { en: "Reveal field of study", uk: "Розкрити спеціальність" },
  "demo.revealFieldOfStudyDesc": { en: "Disclose the field of study with ZK proof of authenticity", uk: "Показати спеціальність з ZK доказом автентичності" },
  "demo.revealStudentNumber": { en: "Reveal student number", uk: "Розкрити номер студентського" },
  "demo.revealStudentNumberDesc": { en: "Disclose the student number with ZK proof of authenticity", uk: "Показати номер студентського з ZK доказом автентичності" },
  "demo.revealStuName": { en: "Reveal student name", uk: "Розкрити ім\u2019я студента" },
  "demo.revealStuNameDesc": { en: "Disclose the student name with ZK proof of authenticity", uk: "Показати ім\u2019я студента з ZK доказом автентичності" },
  "demo.revealStuUniversity": { en: "Reveal university", uk: "Розкрити університет" },
  "demo.revealStuUniversityDesc": { en: "Disclose the university name with ZK proof of authenticity", uk: "Показати назву університету з ZK доказом автентичності" },
  "demo.revealFaculty": { en: "Reveal faculty", uk: "Розкрити факультет" },
  "demo.revealFacultyDesc": { en: "Disclose the faculty name with ZK proof of authenticity", uk: "Показати назву факультету з ZK доказом автентичності" },
  "demo.revealVin": { en: "Reveal VIN", uk: "Розкрити VIN" },
  "demo.revealVinDesc": { en: "Disclose the vehicle identification number with ZK proof of authenticity", uk: "Показати VIN з ZK доказом автентичності" },
  "demo.revealPlateNumber": { en: "Reveal plate number", uk: "Розкрити номерний знак" },
  "demo.revealPlateNumberDesc": { en: "Disclose the plate number with ZK proof of authenticity", uk: "Показати номерний знак з ZK доказом автентичності" },
  "demo.revealOwnerName": { en: "Reveal owner name", uk: "Розкрити ім\u2019я власника" },
  "demo.revealOwnerNameDesc": { en: "Disclose the owner name with ZK proof of authenticity", uk: "Показати ім\u2019я власника з ZK доказом автентичності" },
  "demo.revealOwnerDocNumber": { en: "Reveal owner document number", uk: "Розкрити номер документа власника" },
  "demo.revealOwnerDocNumberDesc": { en: "Disclose the owner document number with ZK proof of authenticity", uk: "Показати номер документа власника з ZK доказом автентичності" },
