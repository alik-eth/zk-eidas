/* @ts-self-types="./zk_eidas_wasm.d.ts" */
 ...
 * @returns {string}
 */
export function build_compound_proof(proofs_json, op) {
    let deferred4_0;
    let deferred4_1;
    try {
        ...
        const ret = wasm.build_compound_proof(ptr0, len0, ptr1, len1);
        var ptr3 = ret[0];
        var len3 = ret[1];
        if (ret[3]) {
            ptr3 = 0; len3 = 0;
 ...
 * @param {string} compound_proof_json
 * @param {boolean} compress
 * @returns {Uint8Array}
 */
export function export_to_envelope(compound_proof_json, compress) {
    const ptr0 = passStringToWasm0(compound_proof_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.export_to_envelope(ptr0, len0, compress);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
 ...
 * @param {string} ecdsa_public_signals
 * @returns {string}
 */
export function generate_holder_binding_inputs(sdjwt, claim_name, ecdsa_public_signals) {
    let deferred5_0;
    let deferred5_1;
    try {
        ...
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passStringToWasm0(ecdsa_public_signals, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len2 = WASM_VECTOR_LEN;
        const ret = wasm.generate_holder_binding_inputs(ptr0, len0, ptr1, len1, ptr2, len2);
        var ptr4 = ret[0];
        var len4 = ret[1];
        if (ret[3]) {
            ptr4 = 0; len4 = 0;
 ...
 * @param {string} sdjwt
 * @param {string} contract_terms
 * @param {string} timestamp
 * @param {string} ecdsa_public_signals
 * @returns {string}
 */
export function generate_nullifier_inputs(sdjwt, contract_terms, timestamp, ecdsa_public_signals) {
    let deferred6_0;
    let deferred6_1;
    try {
        const ptr0 = passStringToWasm0(sdjwt, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(contract_terms, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passStringToWasm0(timestamp, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len2 = WASM_VECTOR_LEN;
        const ptr3 = passStringToWasm0(ecdsa_public_signals, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len3 = WASM_VECTOR_LEN;
        const ret = wasm.generate_nullifier_inputs(ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3);
        var ptr5 = ret[0];
        var len5 = ret[1];
        if (ret[3]) {
            ptr5 = 0; len5 = 0;
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('zk_eidas_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
