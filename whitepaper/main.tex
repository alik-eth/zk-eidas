...
achieve \textasciitilde17\,ms proving time for the ECDSA~P-256 signature
sub-circuit, with end-to-end proving in approximately 1.3\,s for
...
\keywords{zero-knowledge proofs, selective disclosure, eIDAS~2.0,
post-quantum cryptography, identity escrow, anonymous credentials}

\input{sections/introduction}
\input{sections/background}
\input{sections/construction}
\input{sections/escrow}
\input{sections/implementation}
\input{sections/evaluation}
\input{sections/eudi-mapping}
