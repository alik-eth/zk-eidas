...
\caption{\textsc{zk-eidas} system architecture. The credential parsing, signature verification, predicate evaluation, and escrow binding all execute within a single Longfellow circuit.}
