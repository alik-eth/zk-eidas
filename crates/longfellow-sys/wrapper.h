...
// --- p7s circuit (Phase 2a, blob protocol v5) ---
//
...
// Task 23 adds json_declaration_offset (v5). Both blobs start with a
// little-endian u32 schema version; the authoritative layout lives in
...
//
// Public blob v5 (unchanged from v3):
//   u32 version = 5
//   u8 context_hash[32]
//   u8 pk[65]
//   u8 nonce[32]
