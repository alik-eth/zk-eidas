...
///
/// Phase 2b ships with N=2 (Task #44):
///   * index 0 = TestAnchorA — synthetic P-256 anchor generated by
///     `gen_synthetic_fixtures` (seed "zk-eidas-test-anchor-A-root-v1").
///     Marker: QTSP reg-code `TQSA-00000000-01`.
///   * index 1 = TestAnchorB — second synthetic P-256 anchor, seed
///     "zk-eidas-p7s-testanchor-b-root-v1". Marker: `TQSB-00000000-02`.
///
/// The earlier DIIA QTSP 2311 marker was removed as part of the PII
/// scrub (Task #43a). Task #37 appends real-QTSP markers once non-PII
/// fixtures land.
///
...
const TRUST_ANCHOR_PROBES: &[(&[u8], u32, &str)] = &[
    ...
    (b"TQSB-00000000-02", 1, "TestAnchorB (synthetic, P-256)"),
];
